-- Exclude admin-impersonation activity from the Dashboard engagement aggregates.
-- Feedback EXISTS subqueries and the claims_* counts now ignore rows tagged with
-- impersonated_by (set when an admin acted while viewing-as a user).
-- Identical to 20260528000001 except for the added `impersonated_by IS NULL` filters.
