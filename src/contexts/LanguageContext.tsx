...
const translations: Translations = {
  ...
  "insights.tab.tourism": { en: "Tourism (Veneto)", it: "Turismo (Veneto)" },
  "insights.tourism.subtitle": {
    en: "Monthly correlation between Veneto tourism (ISTAT) and cover activations, by province.",
    it: "Correlazione mensile tra turismo in Veneto (ISTAT) e attivazione coperture, per provincia.",
  },
  ...
  "insights.tourism.noCorrelations": {
    en: "Not enough overlapping months to compute correlations. Need at least 6 months of policies in a Veneto province.",
    it: "Mesi sovrapposti insufficienti per calcolare le correlazioni. Servono almeno 6 mesi di polizze in una provincia veneta.",
  },
  ...
  "insights.tourism.unmatched": { en: "Italian shops not mapped to a Veneto comune", it: "Negozi italiani non mappati su un comune veneto" },
  "insights.tourism.unmatchedHint": {
    en: "These cities aren't in the Veneto comune list, so their policies are excluded. Extend veneto_comune_province to include them.",
    it: "Queste città non sono nella lista dei comuni veneti, quindi le loro polizze sono escluse. Estendi veneto_comune_province per includerle.",
  },
