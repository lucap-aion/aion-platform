...
const translations: Translations = {
  ...
  "insights.chart.newProfiledMonthly": { en: "New profiled clients per month (% of new clients)", it: "Nuovi clienti profilati per mese (% sui nuovi clienti del mese)" },
  "insights.chart.newProfiledMonthlyByShopPrefix": { en: "Profiled per month — ", it: "Profilati per mese — " },
