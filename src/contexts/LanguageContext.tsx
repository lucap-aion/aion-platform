...
const translations: Translations = {
  ...
  "insights.chart.newProfiledMonthlyByShop": { en: "New profiled clients per month by store (% of new clients per store)", it: "Nuovi clienti profilati per mese per negozio (% sui nuovi clienti per negozio)" },
  ...
  "insights.chart.newFeedbackMonthlyByShop": { en: "New feedback clients per month by store (% of new clients per store)", it: "Nuovi clienti con feedback per mese per negozio (% sui nuovi clienti per negozio)" },
