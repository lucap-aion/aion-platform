...
const translations: Translations = {
  ...
  "insights.chart.newProfiledMonthly": { en: "New profiled clients per month", it: "Nuovi clienti profilati per mese" },
  "insights.chart.newProfiledMonthlyByShop": { en: "New profiled clients per month — by store", it: "Nuovi clienti profilati per mese — per negozio" },
  "insights.chart.newFeedbackMonthly": { en: "New feedback clients per month", it: "Nuovi clienti con feedback per mese" },
  "insights.chart.newFeedbackMonthlyByShop": { en: "New feedback clients per month — by store", it: "Nuovi clienti con feedback per mese — per negozio" },
