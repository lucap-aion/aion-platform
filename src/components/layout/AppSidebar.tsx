...
import { Home, Shield, FileText, Users, BarChart3, HelpCircle, UserCircle, LogOut, BookOpen, Search, Send, ChevronsUpDown, UserCog, LineChart, Sparkles, Store, MessageSquare, Megaphone, Heart } from "lucide-react";
...
const brandMasterPaths = [
  ...
  { path: "/faq", icon: MessageSquare, labelKey: "nav.faq" },
];
